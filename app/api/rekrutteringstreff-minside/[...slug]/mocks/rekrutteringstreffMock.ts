...
const createMockRekrutteringstreff = (): EnkeltRekrutteringstreffDTO => {
  ...
  return {
    ...
    arbeidsgivere: Array.from(
      { length: faker.number.int({ min: 1, max: 4 }) },
      () => ({
        organisasjonsnummer: faker.number
...
const createMockRekrutteringstreffFremITid =
...
const createMockRekrutteringstreffTilbakeITid =
  (): EnkeltRekrutteringstreffDTO => {
...
const createMockRekrutteringstreffAvlyst = (): EnkeltRekrutteringstreffDTO => {
  ...
  return {
    ...
    tittel: 'test adresse',
    innlegg: [{ tittel: 'Om treffet', htmlContent: '<p>Test</p>' }],
  };
};

const createMockRekrutteringstreffForskjelligFormattering =
  (): EnkeltRekrutteringstreffDTO => {
    const fraTid = faker.date.soon({ days: 30 });
    const tilTid = faker.date.soon({ refDate: fraTid, days: 3 });
    return {
      ...
      innlegg: [
        {
          tittel: 'Forskjellig formattering',
          htmlContent:
            '<p><strong>Bold</strong></p><p><strong><em>Italic</em></strong></p><p>Liste</p><ul><li><p>punkt 1</p></li><li><p>punkt 2</p></li></ul>Siste linje',
        },
      ],
    };
  };

const createMockRekrutteringstreffSvarfristUtløpt =
  (): EnkeltRekrutteringstreffDTO => {
    const fraTid = faker.date.soon({ days: 5 });
    const tilTid = faker.date.soon({ refDate: fraTid, days: 3 });
    return {
...
const createMockRekrutteringstreffUtkast = (): EnkeltRekrutteringstreffDTO => ({
  ...createMockRekrutteringstreffFremITid(),
  status: RekrutteringstreffStatus.UTKAST,
});

const createMockRekrutteringstreffPublisert =
  (): EnkeltRekrutteringstreffDTO => ({
    ...createMockRekrutteringstreffFremITid(),
    status: RekrutteringstreffStatus.PUBLISERT,
  });

const createMockRekrutteringstreffFullført =
  (): EnkeltRekrutteringstreffDTO => ({
    ...createMockRekrutteringstreffTilbakeITid(),
    status: RekrutteringstreffStatus.FULLFØRT,
  });

const createMockRekrutteringstreffSlettet =
  (): EnkeltRekrutteringstreffDTO => ({
    ...createMockRekrutteringstreff(),
...
export const mockRekrutteringstreffFremITid =
  createMockRekrutteringstreffFremITid();
export const mockRekrutteringstreffTilbakeITid =
  createMockRekrutteringstreffTilbakeITid();
export const mockRekrutteringstreffIGang = createMockRekrutteringstreffIGang();
export const mockRekrutteringstreffAvlyst =
  createMockRekrutteringstreffAvlyst();
export const mockRekrutteringstreffForskjelligFormattering =
  createMockRekrutteringstreffForskjelligFormattering();
export const mockRekrutteringstreffSvarfristUtløpt =
  createMockRekrutteringstreffSvarfristUtløpt();
export const mockRekrutteringstreffUtkast =
  createMockRekrutteringstreffUtkast();
export const mockRekrutteringstreffPublisert =
  createMockRekrutteringstreffPublisert();
export const mockRekrutteringstreffFullført =
